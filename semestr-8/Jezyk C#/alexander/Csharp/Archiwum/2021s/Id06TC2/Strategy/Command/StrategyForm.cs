...
namespace Command
{
    public partial class StrategyForm : Form
    {
        ...
        {
            InitializeComponent();
            foreach(string strategy in StrategyRunFactory.keys) cbRun.Items.Add(strategy);
        ...
        {
            StrategyRun strun=StrategyRunFactory.get(cbRun.SelectedItem.ToString());

            Sportsmen sporsmen = new Sportsmen("Jan Kowalski", strun);
