...
{
    public partial class CommanStrategydForm : Form
    {
        public CommanStrategydForm()
        {
            InitializeComponent();
            //foreach(SportsmanCommand cmd in SportsmanCommandFabric.basic) LbCommands.Items.Add(cmd);
            LbCommands.Items.AddRange(SportsmanCommandFabric.basic);
        ...
        private void BtnExecute_Click(object sender, EventArgs e)
        {
            ...
            Sportsman sm = new Sportsman(name, run, jump, swim);
            SportsmanCommand cmd = LbCommands.SelectedItem as SportsmanCommand;
