...
namespace Steganography
{
    public partial class SteganographyMain : Form
    {
        ...
        {
            Color[,] clr = BitmapHelper.BitmapArray.BmpToArr(bmp);
            byte[] arr = ColorArray.ClrToBytes(clr);
            ...
            clr = ColorArray.BytesToClr(arr, clr.GetLength(0), clr.GetLength(1));
            bmp = BitmapHelper.BitmapArray.ArrToBmp(clr);
            BmpBox.Image = bmp;
        }
