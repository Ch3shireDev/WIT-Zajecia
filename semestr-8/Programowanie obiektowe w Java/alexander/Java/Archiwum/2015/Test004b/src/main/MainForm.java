...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        ...
        setTitle("Kalkulator");
        setResizable(false);
        BtnPoint.setText(""+(new DecimalFormatSymbols().getDecimalSeparator()));
        NeedClear=true;        
        SavedValue=0;
        Operation="";
    ...
    private void initComponents() {
        ...
        Display.setFont(new java.awt.Font("Courier New", 1, 24)); // NOI18N
    ...
    private void formKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyTyped
        String sep=""+(new DecimalFormatSymbols().getDecimalSeparator());
    ...
    private void BtnDigitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDigitActionPerformed
        if(NeedClear) Display.setText("");
        if(Display.getText().length()>=DisplaySize) return;
    ...
    private void BtnPointActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPointActionPerformed
        if(NeedClear) Display.setText("0");
    ...
    private void BtnOpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnOpActionPerformed
        if(!NeedClear) {
            double NextValue=Double.parseDouble(Display.getText());
            switch(Operation) {
            ...
            String str=new DecimalFormat("0.##################").format(SavedValue);
            if(str.equals("∞")) str="+∞";
            else if(str.equals("�")) str="∞";
            Display.setText(str.substring(0, Math.min(str.length(), DisplaySize)));
        }
        JButton btn=(JButton)evt.getSource();
