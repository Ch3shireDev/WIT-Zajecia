public class SimpleCalculatorMainForm extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        TfOperandA.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        TfOperandA.setText("0");

        CbOperation.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "opr" }));

        TfOperandB.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(BtnCalculate))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TaResultsScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 301, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void BtnCalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCalculateActionPerformed
        ...
        double result=OperationFactory.execute(a,op,b);
