...
public class StrategyCommandMainForm extends javax.swing.JFrame
{
    ...
    private DefaultComboBoxModel<String> runing=new DefaultComboBoxModel<>();
            
    public StrategyCommandMainForm()
    {
        initComponents();
        ...
        CbStrategyRun.setModel(runing);
        //runing.addElement("Marathon");
    ...
    {
        java.awt.EventQueue.invokeLater(() -> new StrategyCommandMainForm().setVisible(true));
    }
