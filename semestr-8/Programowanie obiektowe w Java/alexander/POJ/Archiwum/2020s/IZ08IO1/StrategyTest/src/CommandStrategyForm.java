...
public class CommandStrategyForm extends javax.swing.JFrame 
{
    ...
    public CommandStrategyForm()
    {
        ...
        for(String kind:StrategyRunFabric.Keys()) CbRun.addItem(kind);
        for(String kind:StrategyJumpFabric.Keys()) CbJump.addItem(kind);
        for(String kind:StrategySwimFabric.Keys()) CbSwim.addItem(kind);
    ...
    private void AdjustButtons()
    {
        ...
        boolean IsTreningSelected=(LbCommands.getSelectedValue() instanceof CommandComplex);
   ...
   private void initComponents() {
      ...
      EdMultiply = new javax.swing.JSpinner();
      ...
      EdMultiply.setModel(new javax.swing.SpinnerNumberModel(Byte.valueOf((byte)3), Byte.valueOf((byte)2), Byte.valueOf((byte)9), Byte.valueOf((byte)1)));
               ...
               .addGroup(layout.createSequentialGroup()
                  ...
                  .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                     ...
                     .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(EdMultiply, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                  .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
   ...
   private void BtnAddMultiplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAddMultiplyActionPerformed
        final Command cmd=new CommandMultiply((byte)EdMultiply.getValue(), LbCommands.getSelectedValue());
        int pos=commandmodel.size();
        commandmodel.addElement(cmd);
        LbCommands.setSelectedIndex(pos);
        AdjustButtons();
   ...
   private javax.swing.JSpinner EdMultiply;
