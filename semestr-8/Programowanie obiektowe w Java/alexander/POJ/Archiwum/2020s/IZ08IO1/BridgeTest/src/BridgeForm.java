...
public class BridgeForm extends javax.swing.JFrame
{
   ...
   private final FigureBridge[] bridges;
   public BridgeForm()
   {
      initComponents();
      ...
      for(String kind : FigureFabric.getKinds()) CbFigKinds.addItem(kind);
         ...
         .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
               .addGroup(layout.createSequentialGroup()
                  ...
                  .addComponent(BtnAdd)
                  .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                  .addComponent(LbFiguresScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 334, Short.MAX_VALUE)
                  .addGap(11, 11, 11))
               .addGroup(layout.createSequentialGroup()
                  .addComponent(PnlFigures, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                  .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
            .addComponent(EdJsonScroll, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addContainerGap())
      );
   ...
   private void BtnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAddActionPerformed
      ...
      list.add(fig);
      for(FigureBridge bridge : bridges) bridge.proceed(list);
