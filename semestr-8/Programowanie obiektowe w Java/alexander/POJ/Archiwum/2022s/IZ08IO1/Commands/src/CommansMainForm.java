...
public class CommansMainForm extends javax.swing.JFrame
{
   ...
   /**
    * Creates new form CommansMainForm
    */
               ...
               .addGroup(layout.createSequentialGroup()
                  ...
                  .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                     ...
                     .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(TfTrainingName, javax.swing.GroupLayout.DEFAULT_SIZE, 263, Short.MAX_VALUE)))
                  .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
   ...
   public static void main(String args[])
   {
      ...
      {
         java.util.logging.Logger.getLogger(CommansMainForm.class.getName()).log(java.util.logging.Level.SEVERE,null,ex);
      }
      ...
      java.awt.EventQueue.invokeLater(new Runnable()
      {
         public void run()
         {
            new CommansMainForm().setVisible(true);
         }
      });
   }
