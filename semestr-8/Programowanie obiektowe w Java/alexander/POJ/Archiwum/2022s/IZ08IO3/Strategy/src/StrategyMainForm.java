...
{
   private DefaultComboBoxModel<SportsmenStrategyRun> runModel=new DefaultComboBoxModel<>();

   public StrategyMainForm()
   {
      initComponents();
      CbStrategyRun.setModel(runModel);
      runModel.addElement(new SportsmenStrategyRunMaraton());
      runModel.addElement(new SportsmenStrategyRunSprint());
   }
   ...
   private void initComponents()
   {
      ...
      javax.swing.JComboBox<String> CbStrategyJump = new javax.swing.JComboBox<>();
      ...
      CbStrategyJump.setName(""); // NOI18N

      CbStrategyRun.setName(""); // NOI18N

      CbStrategySwim.setName(""); // NOI18N
