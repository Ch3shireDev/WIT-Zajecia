...
public class BridgeForm extends javax.swing.JFrame
{
   public BridgeForm()
   {
      initComponents();
/*
      JPanel x = new OwnerDrawPanel(this::onpaint);
      JPanel y = new OwnerDrawPanel
      (
         new  DrawCall()
         {
            @Override public void onDraw(Graphics g)
            {
               onpaint(g);
            }
         }
...
*/
   ...
   private void onpaint(Graphics g)
   {
      ...
      g.drawPolyline(new int[]{100,400,400,100}, new int[]{100,100,500,100}, 4);
   ...
   private void initComponents() {
      ...
      setPreferredSize(new java.awt.Dimension(649, 404));
         ...
         .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
               ...
               .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                  ...
                  .addComponent(EdCbFigureParameters, javax.swing.GroupLayout.DEFAULT_SIZE, 475, Short.MAX_VALUE)
                  .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
