...
public class DecoratorForm extends javax.swing.JFrame {
   ...
   /**
    * Creates new form DecoratorForm
    */
   public DecoratorForm() {
      initComponents();
      LcbDecorators.setLayout(new BoxLayout(LcbDecorators,BoxLayout.Y_AXIS));
      LcbDecorators.add(new JCheckBox("Aaa"));
      LcbDecorators.add(new JCheckBox("Bbb"));
      LcbDecorators.add(new JCheckBox("Ccc"));
      LcbDecorators.add(new JCheckBox("Ddd"));
      LcbDecorators.add(new JCheckBox("Eee"));
      LcbDecorators.add(new JCheckBox("Fff"));
      LcbDecorators.add(new JCheckBox("Ggg"));
   }
   ...
   private void initComponents() {
      ...
      layout.setHorizontalGroup(
         ...
         .addGroup(layout.createSequentialGroup()
            .addContainerGap()
            .addComponent(LcbDecorators, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
   ...
   public static void main(String args[]) {
      ...
      try {
         ...
         java.util.logging.Logger.getLogger(DecoratorForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
