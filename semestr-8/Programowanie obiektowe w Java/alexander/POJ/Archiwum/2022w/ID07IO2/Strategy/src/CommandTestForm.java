...
public class CommandTestForm extends javax.swing.JFrame {
    ...
    public CommandTestForm() {
        ...
        for(String kind:SportsmenStrategySwimFactory.keys) cbStrategySwim.addItem(kind);
   ...
   private void initComponents()
   {
    ...
    private void btnExecuteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExecuteActionPerformed
        final String sportsmanName = tfSportsmanName.getText();
        final SportsmenStrategySwim stSwim=SportsmenStrategySwimFactory.make(cbStrategySwim.getSelectedItem().toString());
        Sportsman sportsman = new Sportsman(sportsmanName,stSwim);
        SportsmanCommand cmd = getSelectedCommand();
