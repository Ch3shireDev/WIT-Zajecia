...
Zakłada się konieczność pracy 5 osób nad elementami projektu. Dodatkowo potrzebna będzie osoba do przeprowadzenia wdrożenia (może to być członek zespołu lub inna osoba z doświadczeniem konfiguracji serwera).
...
2. Ustalenie interfejsów pomiędzy podprojektami.
...
1. Konsultacja z klientem i naniesiesienie zmian w planach struktury.
...
1. Konsultacja z klientem po przygotowaniu wersji alfa - zbieranie uwag i zmiany w planach projektu.
...
7. Przygotowanie wersji beta dla klienta + testowanie.
