...
// double - liczba int w postaci dziesiatkowej
//
// Copyright MW
...
printf("Na jaki system chcesz konwertowac? (2,8,10,16) : ");	scanf("%i",&op);

while(op!=2 && op!=8 && op!=10 && op!=16) {
...
case 10 : printf("dziesietny"); break;
